...
(the exact order will be determined by spinning the wheel, as usual).

After the performances we'll have a discussion about our works-in-progress in
relation to the [marking criteria](/deliverables/lens-performance/#marking) for the final performances.
