...
then that's great. During classes (e.g. the [workshop sessions](/workshops/)) we expect you to bring your laptop (and charger), and some
headphones.
...
![download box on the Pd website](/images/resources/pd-download-box.png)
...
it every week for your [AV diary submission](/deliverables/audiovisual-diary/#weekly-videos).
...
one or the other as the foundation for your final [LENS performance](/deliverables/lens-performance/). Still, if you're keen to explore further
