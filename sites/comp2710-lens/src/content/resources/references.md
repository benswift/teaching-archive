...
All of these resources are freely available on the web or available free (to
you) through the ANU library website.

## Pd Books and Resources:

- _Kreidler, J._
  [Programming Electronic Music in Pd](http://www.pd-tutorial.com) (2013).
  _available free online_
- _Puckette, M._
  [Theory and Technique of Electronic Music](http://msp.ucsd.edu/techniques.htm)
  (2007). _available free online_

## Extempore and Live Coding Books and Resources

- _Sorensen, A._
  [Extempore: The design, implementation and application of a cyber-physical programming language](https://openresearch-repository.anu.edu.au/bitstream/1885/144603/1/Sorensen%20Thesis%202018.pdf)
  (ANU PhD thesis, 2018)
...
- _Roads, C._ (1996). The computer music tutorial. Cambridge, MA: MIT Press
  _[available](https://library.anu.edu.au/record=b1924457) in ANU library_
