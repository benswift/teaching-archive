...
date: 2019-01-11
title: CHINA Stage Project Diary
week: 7
---
...
For Arduino codes, I am still on my way getting familiar with them:

This week, I have successfully read **photoresistor** data from the brightness sensor. Also, I have tried to use **relay module** -- I have made a "photo switch" to control the relay with whether the brightness level reaching the default value.
...
I combined the pulley system that will be used for my artefact as well. I designed to use "relay module" to control them. (The initial manual controlled pulley is bought from [taobao](https://item.taobao.com/item.htm?spm=a1z09.2.0.0.590a2e8d7Da2hz&id=579163637125&_u=ohqocm01cd2), while I need to change it into an intelligent version~)

The lighting components and water pump have arrived as well~
...
(Although it is empty currently, I promise more interesting things will be added when I come back to CBR :))

## Current Problems & Next-week Duties

1. No good design came out for "heating" yet... Still need to think about it.
2. I need to finish "land-water swap" operating device -- sticking physical components, and begin to control it using Arduino.
3. Begin to connect pump and lamps with Arduino board. (More efforts on codes~)
4. I've bought a ESP32 development board, while I only want to use it as a WIFI module. Currently, I still have no idea about how to link it with my Arduino Uno:( ... I will explore more on that next week!

Hope there is still sufficient time for everything~
