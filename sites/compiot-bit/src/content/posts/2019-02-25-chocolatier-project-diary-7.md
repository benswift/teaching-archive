...
I;m done. Not because I've _finished_ the project. Not by a long shot. But because I'm _done_. I'm done with Computer Science. I'm done with Hardware. I'm done with any real world programming. I'm so done that, if I were a Ninja Turtle, I'd be Done-atello
...
When I ran the code the last time, all the camera saw was my face and a white wall. So face tracking worked fine in 100p. Which also wasn't very CPU intensive. But testing against a noisier background - it seems to detect faces _everywhere_, making the tracking almost pointless. I had up the resolution to 720p for it to have a low enough false positive rate. But that just hogs all the CPU, leaving little room to do anything.
