...
This sounds great, but Espressif uses a proprietary "Xtensa" architecture, which cannot be targeted by LLVM. This means we _cannot target ESP chips with LLVM-based languages_, like Rust. We can only use microcontrollers with architectures supported by LLVM.
