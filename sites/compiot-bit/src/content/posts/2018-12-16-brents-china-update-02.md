...
#### *In this chapter, a mood bracelet for the 21st century and the technical details behind a smart body pillow*

## Idea Generation

### EMB: Emoji Mood Bracelet
##### *A Mood Bracelet for the 21st Century*
...
This is achieved by displaying 1 or so *emoji based* images that represent the activity each person is doing, for example:
* Activity Based
    * 🍗, 🍜, ... : Eating
    * 🏃, 💪, 🚴, ... : Exercising
    * ⚽ : Playing a Sport
