...
The lectures about Big Data in Beijing also got us interested in what we could do with the data, after thousands of people have begun to use our service. One potentially useful (and certainly exciting!) idea we had was to collate the location and create a heat map in real time of the air quality in major cities. This data could then be used to send updates to users _ahead of time_ about the air quality along, for example, the route they take everyday for work.
