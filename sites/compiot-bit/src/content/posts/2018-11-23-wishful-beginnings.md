...
My interest in NMPS stemmed from a desire to explore agency in live performance. What happens when the agents involved in a live performance are not soley the musicians? What if the audience or even an intelligent algorithm is thrown into the mix? How would this affect the creative flow of the performance? Tod Machover's work on [Hyperinstruments](https://quod.lib.umich.edu/cgi/p/pod/dod-idx/hyperinstruments-musically-intelligent-and-interactive.pdf?c=icmc;idno=bbp2372.1989.046;format=pdf) was particularly inspiring. In a nout-shell, this system collects MIDI data from musicians' instruments which is passed through a central algorithm where this data is analyzed. From here, the system is able to trigger MIDI events on other instruments, augment timbres and intelligently choose rhythmic patterns the performance must follow. Check out the Hyperinstruments paper linked above for more details.

At this stage, my ideas for a project are hazy to say the least, but reading through existing work in this area has given me some direction and more than enough inspiration. I'm keen to see what I'll churn out in the end.

To everyone embarking on this trip with me, I'm so excited to meet and share ideas with all of you and take in as much of China as I can over the next three weeks, camera in hand.
