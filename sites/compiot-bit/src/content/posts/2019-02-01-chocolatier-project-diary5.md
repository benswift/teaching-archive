...
After spending the majority of yesterday and this morning trying to find out why it wouldn't work, I decided *Fuck it. I'll do it from scratch.* So I flash a new copy of Raspbian onto the SD card, and install the camera again.  
...
__Update 08 Feb 2019:__ Added photos showing the CSI cable is hidden from sight during normal operation. 