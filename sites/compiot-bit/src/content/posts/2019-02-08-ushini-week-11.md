...
![prototype](/images/posts/ushini/prototype.jpg)
...
Btw, the tempo stuff should be fairly similar. The tempo can be updated with the *(\*metro* 'set-tempo 75)*, this requires the live coder to define a metronome in their code.

Edit: I completely forgot that you can set a variable value with *(set! vol1 70)*, so there is no need to have a predetermined pattern/function. You just need to define the vol1 variable in your code. Silly me.
...
![errors](/images/posts/ushini/errors.jpg)
