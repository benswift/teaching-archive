...
1. Vibration sensor
   1.  First attempt:
        - Setting up: the sensor is connected to the side of the drum rigidly through the board I soldered the sensor onto.
            ...
            ![First set up of vibration sensor](/images/posts/zoey/week8-VsensorS1.jpeg)
...
2. Microphone (Fourior transform)
        - Set up: The microphones are placed at the bottom surface of the drum, one touching the drum and one not.
        - The connection between microphone and ESP32 is a bit more complicated than the vibration sensor.
            ...
            ![circuit](/images/posts/zoey/week8-circuit.jpeg)
