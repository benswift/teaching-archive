...
[^logic]: Well, not quite. I would be remiss to say that I didn't enjoy [Logic](https://programsandcourses.anu.edu.au/course/comp2620), but so far that's the sole exception.

## Tour

The "Tour" part of "Study Tour" was much better. Beijing is like every big city ever, so navigating it is quite easy, but there is still a lot of interesting content.

So far I've visited Summer Palace, The Forbidden City and The Temple of Heaven.

The Summer Palace was okay.

The Forbidden City on the other hand was quite interesting. Especially it's Hall of Clocks and Watches. There was also this really cool exibhit of consisting of pieces of Antikythera shipwreck. Within that exhibition I learnt about the exceptionally cool [Antikythera Mechanism](https://en.wikipedia.org/wiki/Antikythera_mechanism), an analog computer for computing astronomical positons. Unfortunately, the main Palace Museum was too crowded to be able to look at pieces properly, so I can't comment on that.
...
For the artefact, I'm considering going back to the drawing board.

My core ideas revolved around violating privacy in some shocking way, but I feel that there is nothing I can do that even remotely approaches the level of creep achieved by corporations like Google, Microsoft and Facebook that users voluntarily give information to. (And I'm forced to participate in, Thanks ANU and the network effect.)

I was linked to the [browser market share](https://netmarketshare.com/browser-market-share.aspx?options=%7B%22filter%22%3A%7B%22%24and%22%3A%5B%7B%22deviceType%22%3A%7B%22%24in%22%3A%5B%22Desktop%2Flaptop%22%5D%7D%7D%5D%7D%2C%22dateLabel%22%3A%22Trend%22%2C%22attributes%22%3A%22share%22%2C%22group%22%3A%22browser%22%2C%22sort%22%3A%7B%22share%22%3A-1%7D%2C%22id%22%3A%22browsersDesktop%22%2C%22dateInterval%22%3A%22Monthly%22%2C%22dateStart%22%3A%222017-12%22%2C%22dateEnd%22%3A%222018-11%22%2C%22segments%22%3A%22-1000%22%7D) on HN earlier this week, and an entire 63% of people use Chrome, inspite of the publicly documented privacy concerns - when there is a [viable privacy respecting alternative](https://www.mozilla.org/).

In fact, this is even worse in China, where WeChat is widely adopted and used for bloody everything, inspite of not having basic features like End to End Encryption for its core functionality.
...
Perhaps I should build a "Smart" something-or-the-other (that I disagree with on a philosophical level) and call it a day, just for the sake of passing this course.

As a footnote, I did consider making the "birds are governemnt surveillance drones" meme real, but [China has already done it](https://www.independent.co.uk/life-style/gadgets-and-tech/news/china-spy-bird-drone-government-surveillance-a8415766.html).
