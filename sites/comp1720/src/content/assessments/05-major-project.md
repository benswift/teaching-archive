...
is to provide an **engaging** and **coherent** viewer experience of *roughly*
...
2. clone[^own-fork] & work on *your* fork of the major project template repo,
...
1. move your files (e.g. any assets not in the `assets` folder) so that they
   *do* get copied by the script (you'll have to update the paths in your sketch
   as well)
