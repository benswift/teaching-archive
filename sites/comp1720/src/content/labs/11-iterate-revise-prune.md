---
title: "Week 11: Iterating, revising and pruning"
---
...
> Think about one idea that you have decided to _ignore_, _abandon_ or _delete_ from your major project. Create and show a simple mock-up that illustrates your abandoned idea and explain what the idea was and why you aren't including it in your major project.
...
One problem with any big project is that we often feel that we _must_ continue on any idea that we have spent time on. This is called the ["sunk cost fallacy"](https://thedecisionlab.com/biases/the-sunk-cost-fallacy/). It can be that the best way to improve a project is to **stop** working on some aspects, and focus only on the bits that are **really good** and contributing to the overall work.

In the pre-lab task you already considered ideas that you might have _ignored_, _abandoned_, or _deleted_, from your major project. Now it's time to discuss this theme with your group and to be brutal about the ideas that are working, and those that aren't.
...
N.B.B.: If you do **really** like all your ideas, have a look at the "major project pitfalls" below and reflect on whether you might be in one of these pits (and still digging). There's plenty of time to make _substantial_ changes in the direction of your work if you start today.
...
(PS: If you haven't read the [major project FAQ](/assessments/05-major-project/#faq), now is a good time!)

N.B: These "pitfalls" come from our experience marking _thousands_ of major projects and assignments. If you think we're not serious that these are a bad idea, think again. (We are serious.)

#### Don't make a game

You're required to make an artwork, not a game. If you start explaining your project by saying "my project will be a role-playing game" then you are on the wrong track. There's more discussion on this point [here](/assessments/05-major-project/#can-i-make-a-game-for-my-major-project).

#### Don't make a powerpoint presentation

If your "interaction" is limited to clicking the mouse to advance through a number of scenes with text explaining what is happening, you're on the wrong track. There's more discussion on this point [here](/assessments/05-major-project/#what-do-you-mean-by-dont-make-a-ppt).

#### Don't overuse /images/code from the internet

As always, you're totally allowed to use /images/code from the internet as long as it is available under a license for your use (preferably creative commons). But using too many assets from the web is likely to hold back your project significantly by overwhelming your original contribution.
