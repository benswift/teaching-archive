...
![Classic tin kaleidoscope](/images/labs/lab-4/kaleidoscope.jpg/)

and when you looked through the tube you saw something like this:

![View inside a kaleidoscope](/images/labs/lab-4/kaleidoscope-view.jpg/)
...
`x=0`, `y=0` point (the *origin*), not the centre of the canvas.
:::
...
Even though it looks complicated, this is a *relatively* simple extension to the
