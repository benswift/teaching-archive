...
2. Develop your ideas for a project aligned with the theme **_"Other Minds"_**
...
**do:** ...`fork` and then `clone` the [Final Project Template
Repo]() and open it in VSCode.

## Final Project

**do:** Read the instructions and assessment criteria for the [Final Project](/deliverables-year-11/03-final-project/). Check out the FAQ. **Ask Questions!**

The project theme for your Final Project is **Other Minds**. This is inspired by the book [**_"Other Minds: The Octopus, the Sea, and the Deep Origins of Consciousness"_**](https://www.harpercollins.com.au/9780008226299/other-minds/) by [Peter Godfrey-Smith](https://en.wikipedia.org/wiki/Peter_Godfrey-Smith).
...
4. Discuss, with one or two others, how the works you've found evolve over time. What do you find interesting and why? Do the works make you _feel_ a certain way and why?
