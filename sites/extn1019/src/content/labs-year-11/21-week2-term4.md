...
0.231e-23; // floating point literals may start with decimal point. Sign of exponent is allowed`
...
let jaya = {
  ...
  cubic: function (x) {
    ...
    else if (typeof x === "bigint") return x ** 3n;
...
The project theme for your Final Project will be **Other Minds**. This is inspired by the book [**_"Other Minds: The Octopus, the Sea, and the Deep Origins of Consciousness"_**](https://www.harpercollins.com.au/9780008226299/other-minds/) by [Peter Godfrey-Smith](https://en.wikipedia.org/wiki/Peter_Godfrey-Smith).
