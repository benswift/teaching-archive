---
title: "Lab 24: Project Work"
tagline: "Consolidating your Final Project"
...
Although there are some words (hello _Artist Statement_ and _Connection to Theme_), the portfolio should include a number of visual elements.
...
Your portfolio should re-introduce us to your interpretation of the theme _**"Other Minds"**_ and your user experience goals. You may use this opportunity to further elaborate your interpretation of the theme and how your interpretation has evolved over the semester. Max 300 words.
...
Ensure that you are clear about your interpretation of the theme and how your artwork relates to the theme _"Other Minds"_.
...
Build on your strengths for this project, and build on the strengths of others to extend your project — figure out how to build your dreams. You can ask your instructors for help, and use existing/found code _with significant modifications_. Ask for help if you are uncertain. You must reference _everything_.
...
- [Reframing](https://www.tandfonline.com/doi/abs/10.1080/10400419.2015.1065134): Shift your perspective / perception
- [Bowerbirding](https://research.usc.edu.au/esploro/outputs/journalArticle/Writer-as-perv-bricolage-bowerbirding-observation/99451303902621): gather inspirations, ideas, ways of doing and making
- [Butterfly Catching](https://themerryfairy.medium.com/catching-glimmers-c16293413eda): write down ideas as they come. Developing a practice of collecting your ideas and flashes of brilliance/tangential thinking will help you appreciate how creative you are, and develop broader creativity
- [Ubuntu](https://en.wikipedia.org/wiki/Ubuntu_philosophy): Work with others. Brainstorm. Bounce ideas around.
- [Playing](https://www.britishcouncil.org/programmes/creative-play/creative-play-and-creativity-part-3): Make a game of it. Have fun. Laugh!
- [Patterning](https://www.mdpi.com/2076-0752/12/4/165): Turn ideas into patterns. Extract patterns from inspirations. [Look for patterns everywhere.](https://brill.com/display/title/28198?language=en)
- [_"Ceci n'est pas une pipe"_](https://en.wikipedia.org/wiki/The_Treachery_of_Images): Metaphorise the world: tell us how it is different — not what it is like.
- [Flowing](https://www.sciencedirect.com/science/article/abs/pii/S0191886919304878): Flow states occur when you are so deeply engaged with an activity that time disappears and distractions do not distract. Flow states are associated with higher levels of creativity.
...
You will include a file called `references.md` which will contain your bibliography. The specifications below are taken and adapted from [the COMP1720 FAQ on references](https://comp.anu.edu.au/courses/comp1720/resources/faq/#references).
...
2. If you have included code/images/text that you did not create in your assignment, you may end up involved in an academic integrity case.
