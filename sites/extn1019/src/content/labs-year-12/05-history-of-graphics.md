...
_You do not necessarily have to do anything about this now. I am just asking you to be aware!_
:::
...
Rather than write a history, I am borrowing [this timeline from Ohio State University](https://ohiostate.pressbooks.pub/graphicshistory/back-matter/cg-historical-timeline/). This timeline ends in 2013 &mdash; _so I guess there have been no developments in graphics since then, right?_
...
(i.e. with the people at your _"pod"_).<br>
...
Suzanne, as provided in that lab, is a low poly model. How do we make it look **_low poly_**? It comes down to shading.
