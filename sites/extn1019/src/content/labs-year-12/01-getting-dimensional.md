...
:::tip
Choose one of the following: (A) Write down all the **meanings** of the word _"dimension"_. (B) Think of, and write as a word cloud, all the words you can that you **associate** with the word _"dimension"_. (C) Find a precise **mathematical definition** of _"dimension"_ [4 minutes]
:::
