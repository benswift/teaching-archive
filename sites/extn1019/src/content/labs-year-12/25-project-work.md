...
1. Work on the build phase for your project
2. Stage and commit changes to demonstrate your project progress
...
**NOTE:** You **must Must MUST stage and commit changes you have made**. A number of students are still to commit any changes &mdash; and we are in week 5 of 9 weeks.

If there are [**blockers**](https://www.atlassian.com/blog/project-management/most-common-project-blockers) for working on your project we will work on identifying and [getting around these](https://services.unimelb.edu.au/counsel/resources/study-related-issues).

The theme for the final project this year is **"&#8230; endings &#8230; beginnings &#8230;"**.

## Part 1: Project Work [100 minutes]

You should be in the build phase of your projects &mdash; writing code to bring your ideas to reality.

If you are still in the ideation phase &ndash; that's OK &ndash; but I need you to finish your ideation today and commit your changes to your gitlab repository.

We are here to help! Ask if you are stuck (for ideas, or ideas on how to transform ideas into code).
...
1. Made significant progress on your final project
2. Documented your progress
